class Nglib < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any, cataline: "9a86c95e0358b98b9d8dcd614167d8e1812407ac1d070c83f52249bce71da960"
  end
  ...
  def install
    ...
    args = std_cmake_args + %W[
      ...
      -DUSE_GUI=OFF
      -DUSE_OCC=ON
      -DOCC_INCLUDE_DIR=#{Formula["freecad/freecad/opencascade@7.5.0"].include}/opencascade
    ]
